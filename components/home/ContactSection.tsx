            ...
            <ScrollAnimatedElement animation="slide-right" delay={100}>
              <div className="bg-white rounded-3xl shadow-xl p-8">
                ...
                <div className="space-y-6">
                  {t.contact.info.addresses && t.contact.info.addresses.map((address: any, index: number) => (
                    <ScrollAnimatedElement key={index} animation="fade-up" delay={200 + index * 50}>
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <h3 className="font-semibold text-paw-dark mb-1">{address.title}</h3>
                          <p className="text-paw-dark/80 font-medium mb-1">{address.company}</p>
                          <p className="text-paw-dark/70">{address.details}</p>
                        </div>
                      </div>
                    </ScrollAnimatedElement>
                  ))}
